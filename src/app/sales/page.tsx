  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 18, marginBottom: 24 }}>
        ...
        <Metric label={t.mRevenueDelta} value={`+${s.monthRevenueDelta}%`} foot={t.salesPeriodLastMonth} valueColor="var(--sage)" footColor="var(--ink3)" />
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.7fr', gap: 22 }}>
        ...
        <div style={{ background: 'var(--card)', border: '1px solid var(--line)', borderRadius: 16, padding: '22px 24px 16px', boxShadow: '0 1px 2px rgba(46,42,37,.04)' }}>
          ...
          {salesTxns.map((tx, idx) => (
            <div key={tx.id} style={{ display: 'grid', gridTemplateColumns: TXN_COLS, gap: 14, padding: '13px 0', alignItems: 'center', borderBottom: idx === salesTxns.length - 1 ? 'none' : '1px solid var(--line)', fontSize: 13 }}>
